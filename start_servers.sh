...
if [[ \$return_code -eq 0 ]]
then
   echo "126 services are starting============="
else
   echo "126 services need to restart================"
fi
...
if [[ \$return_code -eq 0 ]]
then
   echo "mss1 server is starting============="
else
   echo "mss1 need to restart================"
fi
...
if [[ \$serv_num -eq 10 ]]
then
   echo "mss1 server startup successfully=========="
else
   echo "mss1 server startup fail================"
fi
exit
EOF
