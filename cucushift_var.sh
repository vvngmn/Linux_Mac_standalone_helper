...
Options:
  ...
  --update-file|-update  The script will update your exsiting var shell script you specified.
" >&2
}
...
update_file() {
    ...
    echo "Your script file has updated, please source it by \$source $shell_path."
...
init_var() {
  ...
  echo $USERS
  echo "please input version you want running on: 4.1/4.2/4.3/4.4, that would decide the version of rules"
  read VERSION
